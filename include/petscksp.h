...
PETSC_DEPRECATED("Use KSPCreateVecs()") PETSC_STATIC_INLINE PetscErrorCode KSPGetVecs(KSP ksp,PetscInt m,Vec** x,PetscInt n,Vec** y) {return KSPCreateVecs(ksp,m,x,n,y);}
