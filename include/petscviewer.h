...
PETSC_EXTERN PetscErrorCode PetscViewerASCIIHTMLPrintf(PetscViewer,const char[],...);
...
PETSC_EXTERN PetscErrorCode PetscViewerASCIISetHTML(PetscViewer);
PETSC_EXTERN PetscErrorCode PetscViewerASCIIGetHTML(PetscViewer,PetscBool*);
