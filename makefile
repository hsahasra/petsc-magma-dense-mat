...
definehtml: chk_petscdir
	@sed "s?man:+\([A-Za-z0-9_]*\)++[A-Za-z0-9_]*++++man+manualpages\(/[A-Za-z0-9/_]*\).html#[A-Za-z0-9_]*?#define html\1 \"<a href=\\\\\"http://www.mcs.anl.gov/petsc/petsc-current/docs/manualpages\2.html\\\\\">\1</a>\"?g" ${LOC}/docs/manualpages/htmlmap | grep -v "man:" > ${PETSC_ARCH}/include/petscdefinehtml.h
