...
#undef __FUNCT__
#define __FUNCT__ "MatCreateSubMatrix_SeqAIJ"
...
#undef __FUNCT__
#define __FUNCT__ "MatCreateMultiProcBlock_SeqAIJ"
PetscErrorCode  MatCreateMultiProcBlock_SeqAIJ(Mat mat,MPI_Comm subComm,MatReuse scall,Mat *subMat)
{
  PetscErrorCode ierr;
  Mat            B;
...
#undef __FUNCT__
#define __FUNCT__ "MatCreateSubMatrices_SeqAIJ"
...
static struct _MatOps MatOps_Values = { MatSetValues_SeqAIJ,
                                ...
                                /*119*/ 0,
                                        ...
                                        0,
                                        0,
                                        MatCreateMultiProcBlock_SeqAIJ,
...
PETSC_EXTERN PetscErrorCode MatCreateFactor_seqaij_pastix(Mat,MatFactorType,Mat*);
#endif
#if defined(PETSC_HAVE_ESSL) && !defined(PETSC_USE_COMPLEX) && !defined(PETSC_USE_REAL_SINGLE) && !defined(PETSC_USE_REAL___FLOAT128)
PETSC_EXTERN PetscErrorCode MatCreateFactor_seqaij_essl(Mat,MatFactorType,Mat*);
#endif
PETSC_EXTERN PetscErrorCode MatConvert_SeqAIJ_SeqAIJCRL(Mat,MatType,MatReuse,Mat*);
PETSC_EXTERN PetscErrorCode MatCreateFactor_seqaij_petsc(Mat,MatFactorType,Mat*);
PETSC_EXTERN PetscErrorCode MatCreateFactor_seqaij_bas(Mat,MatFactorType,Mat*);
...
PETSC_EXTERN PetscErrorCode MatCreateFactor_seqaij_superlu(Mat,MatFactorType,Mat*);
#endif
#if defined(PETSC_HAVE_SUPERLU_DIST)
PETSC_EXTERN PetscErrorCode MatCreateFactor_seqaij_superlu_dist(Mat,MatFactorType,Mat*);
#endif
#if defined(PETSC_HAVE_UMFPACK)
PETSC_EXTERN PetscErrorCode MatCreateFactor_seqaij_umfpack(Mat,MatFactorType,Mat*);
#endif
#if defined(PETSC_HAVE_CHOLMOD)
PETSC_EXTERN PetscErrorCode MatCreateFactor_seqaij_cholmod(Mat,MatFactorType,Mat*);
#endif
#if defined(PETSC_HAVE_LUSOL)
PETSC_EXTERN PetscErrorCode MatCreateFactor_seqaij_lusol(Mat,MatFactorType,Mat*);
#endif
#if defined(PETSC_HAVE_MATLAB_ENGINE)
PETSC_EXTERN PetscErrorCode MatCreateFactor_seqaij_matlab(Mat,MatFactorType,Mat*);
...
PETSC_EXTERN PetscErrorCode MatCreate_SeqAIJ(Mat B)
{
...
#if defined(PETSC_HAVE_MATLAB_ENGINE)
  ierr = PetscObjectComposeFunction((PetscObject)B,"MatCreateFactor_matlab_C",MatCreateFactor_seqaij_matlab);CHKERRQ(ierr);
...
#endif
#if defined(PETSC_HAVE_PASTIX)
  ierr = PetscObjectComposeFunction((PetscObject)B,"MatCreateFactor_pastix_C",MatCreateFactor_seqaij_pastix);CHKERRQ(ierr);
#endif
#if defined(PETSC_HAVE_ESSL) && !defined(PETSC_USE_COMPLEX) && !defined(PETSC_USE_REAL_SINGLE) && !defined(PETSC_USE_REAL___FLOAT128)
  ierr = PetscObjectComposeFunction((PetscObject)B,"MatCreateFactor_essl_C",MatCreateFactor_seqaij_essl);CHKERRQ(ierr);
#endif
#if defined(PETSC_HAVE_SUPERLU)
  ierr = PetscObjectComposeFunction((PetscObject)B,"MatCreateFactor_superlu_C",MatCreateFactor_seqaij_superlu);CHKERRQ(ierr);
#endif
#if defined(PETSC_HAVE_SUPERLU_DIST)
  ierr = PetscObjectComposeFunction((PetscObject)B,"MatCreateFactor_superlu_dist_C",MatCreateFactor_seqaij_superlu_dist);CHKERRQ(ierr);
#endif
#if defined(PETSC_HAVE_MUMPS)
  ierr = PetscObjectComposeFunction((PetscObject)B,"MatCreateFactor_mumps_C",MatCreateFactor_aij_mumps);CHKERRQ(ierr);
#endif
#if defined(PETSC_HAVE_UMFPACK)
  ierr = PetscObjectComposeFunction((PetscObject)B,"MatCreateFactor_umfpack_C",MatCreateFactor_seqaij_umfpack);CHKERRQ(ierr);
#endif
#if defined(PETSC_HAVE_CHOLMOD)
  ierr = PetscObjectComposeFunction((PetscObject)B,"MatCreateFactor_cholmod_C",MatCreateFactor_seqaij_cholmod);CHKERRQ(ierr);
#endif
#if defined(PETSC_HAVE_LUSOL)
  ierr = PetscObjectComposeFunction((PetscObject)B,"MatCreateFactor_lusol_C",MatCreateFactor_seqaij_lusol);CHKERRQ(ierr);
#endif
#if defined(PETSC_HAVE_CLIQUE)
  ierr = PetscObjectComposeFunction((PetscObject)B,"MatCreateFactor_clique_C",MatCreateFactor_aij_clique);CHKERRQ(ierr);
#endif

  ierr = PetscObjectComposeFunction((PetscObject)B,"MatCreateFactor_petsc_C",MatCreateFactor_seqaij_petsc);CHKERRQ(ierr);
  ...
  ierr = PetscObjectComposeFunction((PetscObject)B,"MatCreateFactor_bas_C",MatCreateFactor_seqaij_bas);CHKERRQ(ierr);
...
/*
    Given a matrix generated with MatCreateFactor() duplicates all the information in A into B
*/
