...
#undef __FUNCT__
#define __FUNCT__ "MatCreateSubMatrix_SeqSBAIJ_Private"
...
#undef __FUNCT__
#define __FUNCT__ "MatCreateSubMatrix_SeqSBAIJ"
PetscErrorCode MatCreateSubMatrix_SeqSBAIJ(Mat A,IS isrow,IS iscol,MatReuse scall,Mat *B)
{
  ...
  ierr = MatCreateSubMatrix_SeqSBAIJ_Private(A,is1,is1,scall,B);CHKERRQ(ierr);
  ierr = ISDestroy(&is1);CHKERRQ(ierr);
  PetscFunctionReturn(0);
}

#undef __FUNCT__
#define __FUNCT__ "MatCreateSubMatrices_SeqSBAIJ"
