...
PetscErrorCode (*PetscVFPrintf)(FILE*,PetscBool,const char[],va_list)    = PetscVFPrintf_Matlab;
#else
PetscErrorCode (*PetscVFPrintf)(FILE*,PetscBool,const char[],va_list)    = PetscVFPrintfDefault;
#endif
/*
